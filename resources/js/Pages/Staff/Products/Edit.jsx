...
export default function ProductsEdit({ auth, product, categories }) {
    const { data, setData, processing, errors } = useForm({
        ...
        lot_number: product.stock_lot_instances?.[0]?.lot_number || '',
        expiry_date: product.stock_lot_instances?.[0]?.expiry_date || '',
    });
    ...
    const submit = (e) => {
        ...
        router.post(route('staff.products.update', product.id), {
            ...data,
            _method: 'put'
        }, {
    ...
    const submitStockUpdate = (e) => {
        e.preventDefault();
        postStock(route('staff.products.stock', product.id), {
            onSuccess: () => {
                    ...
                    <div className="mb-8">
                        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 lg:gap-6">
                            <div className="min-w-0 flex-1">
                                ...
                                <p className="text-sm lg:text-base text-gray-600 mt-1 lg:mt-2">อัปเดตข้อมูลสินค้า - {product.name}</p>
                            </div>
                        ...
                        <div className="lg:col-span-2">
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                                <div className="p-6 border-b border-gray-100">
                                    ...
                                    <p className="text-sm text-gray-600 mt-1">อัปเดตรายละเอียดและการตั้งค่า</p>
                                </div>
                                <div className="p-6">
                                                ...
                                                <div className="flex">
                                                    ...
                                                    <div className="ml-3">
                                                        ...
                                                        <div className="mt-2 text-sm text-orange-700">
                                                            ...
                                                            <p className="mt-1">
                                                                <strong>แนะนำ:</strong> ใช้ปุ่ม "ปรับปรุงสต็อก" เพื่อเพิ่มข้อมูล Lot และหมายเหตุ
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="space-y-1 text-center">
                                                    ...
                                                    <div className="flex text-sm text-gray-600">
                                                        <label htmlFor="image" className="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                                            <span>{product.image ? 'อัปโหลดรูปภาพใหม่' : 'อัปโหลดไฟล์'}</span>
                                                            <input
                                                                id="image"
                                                                type="file"
                                                                accept="image/*"
                        ...
                        <div className="lg:col-span-1">
                            ...
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-6">
                                <div className="flex">
                                    ...
                                    <div className="ml-3">
                                        <h3 className="text-sm font-medium text-blue-800">การจัดการสต็อกขั้นสูง</h3>
                                        <div className="mt-2 text-sm text-blue-700">
                                            <p>ใช้ปุ่ม "ปรับปรุงสต็อก" เพื่อเพิ่มข้อมูล Lot และวันหมดอายุ</p>
                                        </div>
                                        <div className="mt-3">
                                            <button
                                                onClick={() => setShowStockModal(true)}
                    ...
                    <div className="relative top-10 mx-auto p-5 border w-full max-w-2xl shadow-lg rounded-2xl bg-white">
                        <div className="mt-3">
                            ...
                            <form onSubmit={submitStockUpdate} className="space-y-6">
                                ...
                                {showLotInfo && (stockData.lot_number || stockData.expiry_date) && (
