...
export default function ReturnedStockManagement({ auth }) {
    ...
    const fetchReturnedStockProducts = async () => {
        try {
            setLoading(true);
            const response = await fetch(`/admin/returns/returned-stock/api/products?search=${searchTerm}`);
    ...
    const handleRestock = async () => {
        ...
        try {
            const response = await fetch(`/admin/returns/returned-stock/api/restock/${selectedProduct.id}`, {
                method: 'POST',
                headers: {
    ...
    const handleDiscard = async () => {
        ...
        try {
            const response = await fetch(`/admin/returns/returned-stock/api/discard/${selectedProduct.id}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
